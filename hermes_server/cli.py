...
def _build_run_parser(sub):
    ...
    run_p.add_argument("--host", default=None, metavar="HOST",
                       help="Bind host (default: 0.0.0.0)")
    run_p.add_argument("--port", default=None, type=int, metavar="PORT",
...
def _build_simulate_parser(sub):
    ...
    sim_p.add_argument("--server", default="http://localhost:8000", metavar="URL",
                       help="Hermes server URL (default: http://localhost:8000)")
    sim_p.add_argument("--event", default=None, metavar="NAME",
                       help="Event type to simulate (omit for interactive menu)")
    sim_p.add_argument("--user", default="Test User", metavar="NAME",
                       help="Display name of the acting user (default: 'Test User')")
    sim_p.add_argument("--user-id", default=None, metavar="GUID",
...
def _cmd_simulate(args: argparse.Namespace):
    ...
    user = {"id": user_id, "displayName": args.user,
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--version", action="version", version=f"hermes-server {__version__}")
